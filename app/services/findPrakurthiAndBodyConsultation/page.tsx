...
export default function Page() {
  ...
  return (
    <div className="container p-5  text-white min-h-screen rounded-lg shadow-lg">
      ...
      {showModal && (
  <div className="flex items-center fixed z-10 inset-0 overflow-y-auto">
    <div className="min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 w-full">
      <div
      ...
      >
        &#8203;
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div>
                <p className="text-center leading-6 font-bold text-teal-800">
                   Body Constitution
                </p>
                <div className="mt-4">
                  ...
                  <p className="text-teal-800 mt-2 text-xl">{result}</p>
                </div>
              </div>
