...
const labels: { [key: string]: string } = {
  ...
  qh6: "Contact Number",
  qh7: "Occupation",
  qh8: "Do you have a family history of hypertension or heart disease?",
  qh9: "Do you have a family history of high cholesterol, heart diseases or stroke?",
  qh10: "Have you been diagnosed with any chronic conditions like hypertension or diabetes?",
  qh11: "Are you currently taking any medications or supplements?",
  qh12: "What does your typical diet look like? Do you consume a lot of salt, processed foods, or caffeine?",
  qh13: "Can you describe your typical diet? (e.g. intake of saturated fats, trans fats, fiber, fruits, and vegetables)",
  qh14: "How often do you exercise and what type of physical activities do you engage in?",
  qh15: "Do you smoke or use tobacco products?",
  qh16: "How much alcohol do you consume, and how frequently?",
  qh17: "Have you experienced any symptoms that might be related to cholesterol levels, such as chest pain, shortness of breath, or fatigue?",
  qh18: "Do you notice any changes in your weight, particularly weight gain?",
  qh19: "Have you experienced similar pain before?",
  qh20: "Have you had your cholesterol levels checked before? If so, what were the results?",
  qh21: "Have you had any recent blood tests, and do you know your current lipid profile (including LDL, HDL, and triglycerides)?",
  qh22: "Are you aware of the lifestyle changes that can help manage cholesterol levels, such as dietary modifications, increased physical activity, and smoking cessation?"
};
...
export default function page() {
    return (
      <Container className="text-justify py-4 justify-center items-center text-base lg:text-xl antialiased">
        <ImageContainer topic="Cholesterol" first_image="/images/Cholesterol_1.png" second_image="/images/Cholesterol_2.png"/>
            ...
            <h5 className="pb-3 font-bold">Ayurvedic Perspective on Hypercholesterolemia</h5>
