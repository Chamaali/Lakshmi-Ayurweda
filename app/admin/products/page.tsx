  ...
  return (
    <Container className="py-8">
      <div className="flex flex-row pb-4 ">
        ...
        <a href="./../../admin/addProduct" className="justify-self-end py-2 px-3 font-medium bg-green-800 no-underline rounded shadow-sm text-white hover:bg-green-900">Add New Product</a>
